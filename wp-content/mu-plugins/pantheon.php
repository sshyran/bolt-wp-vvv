...
/*
  ...
  Description: Building on Pantheon's and WordPress's strengths, together. Only active when on Pantheon environment.
  Version: 0.1
  Author: Pantheon
...
if ( isset( $_ENV['PANTHEON_ENVIRONMENT'] ) ) {
	...
	require_once( 'pantheon/pantheon-debug.php' );
